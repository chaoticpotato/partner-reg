    ...
    <main className="bg-mySmoke min-h-screen">
      ...
      <div className="wrapper max-w-[50rem] py-6 sm:py-9 lg:py-11.5">
        <div className="px-[3px] flex flex-col gap-3 lg:gap-5 mb-3 lg:mb-5">
          ...
          <h1 className="font-bold text-2xl/normal lg:text-my2xl text-white">
            Join our network
          </h1>
        ...
        <section className="bg-white rounded-[30px] lg:rounded-[40px] px-4 py-6 lg:p-[45px] border border-myBlack">
